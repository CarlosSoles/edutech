...
def dashboard_page():
        ...
        if alumno_seleccionado_str:
            ...
            if evidencias_alumno:
                ...
                for _, row in df_areas.iterrows():
                    ...
                    color = "#D98E3D" if area == "Personal Social" else ("#2D6A66" if area == "Comunicación" else "#C24C3F")
    ...
    # --- EFECTIVIDAD PEDAGÓGICA (LINE CHART) ---
    if alumno_seleccionado_str:
        ...
        if asesorias_alumno:
            ...
            if asesorias_resueltas:
                ...
                <style>
                  ...
                  body{{ margin:0; font-family:'Inter', sans-serif; color:var(--ink); background:transparent; }}
                  .section-card{{ background:var(--card); border:1px solid var(--line); border-radius:var(--radius); padding:22px 24px; box-shadow:var(--shadow); }}
                ...
                <div class="section-card">
                  <div class="section-head">
                    <h2 class="section-title">🕓 Evolución del Aprendizaje (Línea de Tiempo)</h2>
                    <p class="section-desc">Índice de progreso general a lo largo de las sesiones evaluadas.</p>
                  </div>
                  <div class="evo-top">
                    <div>
                      <div class="evo-metric-label">Índice de Progreso General</div>
                  ...
                  {"<div class='evo-empty-note'><svg viewBox='0 0 24 24' fill='none' stroke='currentColor' stroke-width='2'><path d='M12 9v4M12 17h.01M10.3 3.9 2.6 18a2 2 0 0 0 1.8 3h15.2a2 2 0 0 0 1.8-3L13.7 3.9a2 2 0 0 0-3.4 0Z'/></svg>Solo hay 1 sesión evaluada. La tendencia será más clara con más registros — la línea se completará automáticamente a medida que se agreguen evaluaciones.</div>" if len(historial_fechas) == 1 else ""}
                </div>
                <script>
                  Chart.defaults.font.family = "Inter, sans-serif";
